...
class Settings(BaseSettings):
    ...
    # Cycle: 25 work / 5 short break  x4, then 15 min long break,
    # then 25/5 x4 more, then a 2h long break after 8 completed cycles.
    pomo_work_min: int = 25
    pomo_short_break_min: int = 5
    pomo_long_break_min: int = 15
    # Break duration (minutes) after the 8th completed work cycle.
    pomo_marathon_break_min: int = 120
    pomo_cycles_per_long_break: int = 8
    pomo_cycles_per_short_set: int = 4
